...
describe("Submit Order", () => {
    beforeEach(() => {
        ...
        cy.get('#email').type('tester00@yopmail.com')
        ...
        cy.wait(3000)
        cy.get('#option-label-size-143-item-170').click() //choose size of product
        cy.wait(3000)
        cy.get('#option-label-color-93-item-50').click() //choose color of product
        cy.wait(3000)
    ...
    it("Checkout - New Address - Flat Rate", () => {
        ...
        cy.fixture('shipping.json').then((shipping) => {
            cy.get('input[name="street[0]"]').type('Tester Street')
            cy.get('input[name="city"]').type('Test City')
            cy.get('select[name="region_id"]').select(5)
            cy.get('input[name="postcode"]').type('11111')
            cy.get('select[name="country_id"]').select(5)
            cy.get('input[name="telephone"]').type('000011110000')
